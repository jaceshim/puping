...
var Plugins = function() {
	...
	var initCircularCharts = function() {
		...
		var initCircularChartsTwo = function() {
		if ($.easyPieChart) {
			// Set default options
			$.extend(true, $.easyPieChart.defaultOptions, {
				lineCap: 'butt',
			...
			// Initialize defaults
			$('.circular-chartTwo').easyPieChart({
				size: 110,
				lineWidth: 10
			});
		}
			...
			var initCircularChartsThree = function() {
		if ($.easyPieChart) {
			// Set default options
			$.extend(true, $.easyPieChart.defaultOptions, {
				lineCap: 'butt',
			...
			// Initialize defaults
			$('.circular-chartThree').easyPieChart({
				size: 110,
				lineWidth: 10
			});
		}
	...
	return {
		...
		init: function () {
			...
			initCircularCharts(); // Easy Pie Chart-Blue
			initCircularChartsTwo(); // Easy Pie Chart-Red
			initCircularChartsThree(); // Easy Pie Chart-Green
